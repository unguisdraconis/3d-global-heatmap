...
export function DisplayModeControl({ value, onChange }: { value: DisplayMode; onChange: (mode: DisplayMode) => void }) {
  return <section className="control-section display-mode-control"><span className="eyebrow">DISPLAY LAYER</span><div className="segmented mode-switch" role="group" aria-label="Temperature layer">
